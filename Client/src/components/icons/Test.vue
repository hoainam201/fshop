  ...
  <div>
    <div class="login_content" :class="{hidden : loginHidden}">
      ...
      <form @submit.prevent="sendPhoneNumber" >
        ...
        <button type="submit" @click="toggleLogin" style="width: 100%; display: block; background-color: #e87800; color: white; border: none; padding: 10px; margin-top: 10px;">Login</button>
      </form>
    </div>
    <div :class="{ activeOtp : otpActive}" class="get-otp_content"
      ...
      <form @submit.prevent="sendOTP" >
        ...
        <button type="submit" @click="toggleLogin" class="login_btn" style="width: 100%; display: block; border-radius: 4px; padding: 0.5rem 1rem; background-color: #e87800; color: #fff; box-shadow: 0 2px 5px rgba(0,0,0,0.1), 0 2px 10px rgba(0,0,0,0.2);">
          Login
        </button>
      </form>
    </div>
